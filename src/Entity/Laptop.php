...
class Laptop
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Location::class, inversedBy="laptops")
     * @ORM\JoinColumn(nullable=false)
     */
    private $location;

    /**
     * @ORM\ManyToOne(targetEntity=Hersteller::class, inversedBy="laptops")
     * @ORM\JoinColumn(nullable=false)
     */
    private $producer;

    /**
     * @ORM\ManyToOne(targetEntity=Benutzer::class, inversedBy="laptops")
     * @ORM\JoinColumn(nullable=false)
     */
    private $benutzer;
